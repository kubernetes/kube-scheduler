...
require (
	...
	k8s.io/dynamic-resource-allocation v0.0.0-20260310174918-c2d48bc04465
...
require (
	...
	k8s.io/apiserver v0.0.0-20260312211654-52628939cae4 // indirect
...
replace k8s.io/kubelet => k8s.io/kubelet v0.0.0-20260312214227-5d1fd9fdd376
