...
require (
	...
	k8s.io/dynamic-resource-allocation v0.0.0-20251008222510-53e2aadc1d89
...
require (
	...
	k8s.io/apiserver v0.0.0-20251008214905-c651ec0cf278 // indirect
	k8s.io/component-helpers v0.0.0-20251008214234-85759c75589a // indirect
