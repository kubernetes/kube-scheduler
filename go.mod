...
require (
	...
	k8s.io/dynamic-resource-allocation v0.0.0-20250911205539-5bcea1aa0efa
...
require (
	...
	k8s.io/apiserver v0.0.0-20250911201325-68aa546374dd // indirect
	k8s.io/component-helpers v0.0.0-20250911200634-ef6688a1204b // indirect
