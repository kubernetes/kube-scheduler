...
require (
	...
	k8s.io/dynamic-resource-allocation v0.0.0-20251023003145-e206d031df0f
...
require (
	...
	k8s.io/apiserver v0.0.0-20251022234702-161b03fabc5b // indirect
	k8s.io/component-helpers v0.0.0-20251022233850-f6d7ac8ebaf9 // indirect
