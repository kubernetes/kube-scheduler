...
require (
	...
	k8s.io/dynamic-resource-allocation v0.0.0-20250910170043-7765e9300341
...
require (
	...
	k8s.io/apiserver v0.0.0-20250910161652-71841658ed40 // indirect
	k8s.io/component-helpers v0.0.0-20250910160901-2e4efeae85b2 // indirect
