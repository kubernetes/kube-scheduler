...
require (
	...
	k8s.io/dynamic-resource-allocation v0.0.0-20251103230316-cfe8f737ce80
...
require (
	...
	k8s.io/apiserver v0.0.0-20251103203455-d7d2bca063d3 // indirect
	k8s.io/component-helpers v0.0.0-20251101153853-bbe62de9fd22 // indirect
